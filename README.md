<div align="center">
  ...
  <img src="https://github.com/tomay3000/ESET-KeyGen/blob/main/img/logo_alt.png?raw=true" alt="logo"/>
    
  ![Version](https://img.shields.io/badge/version-1.5.5.8-gold)
  
  [![Commit activity](https://img.shields.io/github/commit-activity/t/tomay3000/ESET-KeyGen/main?cacheSeconds=0)](https://github.com/tomay3000/ESET-KeyGen/commits/main)
  ![Last commit](https://img.shields.io/github/last-commit/tomay3000/ESET-KeyGen/main?cacheSeconds=0)
  ![Last test](https://img.shields.io/badge/last_test-14.08.2025_15:47_UTC+3-blue)
  [![Opened issues](https://img.shields.io/github/issues/tomay3000/ESET-KeyGen?color=darkred)](https://github.com/tomay3000/ESET-KeyGen/issues?cacheSeconds=0)
  [![Closed issues](https://img.shields.io/github/issues-closed/tomay3000/ESET-KeyGen?color=darkgreen&cacheSeconds=0)](https://github.com/tomay3000/ESET-KeyGen/issues?q=is%3Aissue+is%3Aclosed)
  ![License](https://img.shields.io/github/license/tomay3000/ESET-KeyGen)
...
---
## 💰 Donations 💰
You can support this project financially by following the link [here](https://github.com/tomay3000/ESET-KeyGen?tab=readme-ov-file#-donations--1) 
...
You can simply use the GitHub actions workflow given [here](https://github.com/tomay3000/ESET-KeyGen/blob/main/.github/workflows/eset.yml) in your GitHub repo.
...
4. If an **ACT0** or **ACT5** error occurs during activation, check whether the ESET HOME account is connected. If so, disconnect it and try again.
   If the error persists, try activating with [Account Generator](https://github.com/tomay3000/ESET-KeyGen/blob/main/wiki/AccountGenerator.md).
